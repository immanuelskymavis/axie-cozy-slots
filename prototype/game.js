...
function preload(){
  // tiny 1x1 to ensure texture pipeline is ready
  this.load.image('px','data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWP4////fwAJJgN9iKZtWwAAAABJRU5ErkJggg==');
}
